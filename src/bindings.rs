...
pub struct Mesh {
    ...
    pub boneIndices: *mut ::std::os::raw::c_uchar,
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of Mesh"][::std::mem::size_of::<Mesh>() - 120usize];
    ...
    ["Offset of field: Mesh::boneCount"][::std::mem::offset_of!(Mesh, boneCount) - 64usize];
    ["Offset of field: Mesh::boneIndices"][::std::mem::offset_of!(Mesh, boneIndices) - 72usize];
    ["Offset of field: Mesh::boneWeights"][::std::mem::offset_of!(Mesh, boneWeights) - 80usize];
    ["Offset of field: Mesh::animVertices"][::std::mem::offset_of!(Mesh, animVertices) - 88usize];
    ["Offset of field: Mesh::animNormals"][::std::mem::offset_of!(Mesh, animNormals) - 96usize];
    ["Offset of field: Mesh::vaoId"][::std::mem::offset_of!(Mesh, vaoId) - 104usize];
    ["Offset of field: Mesh::vboId"][::std::mem::offset_of!(Mesh, vboId) - 112usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct Shader {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ModelSkeleton"][::std::mem::size_of::<ModelSkeleton>() - 24usize];
    ["Alignment of ModelSkeleton"][::std::mem::align_of::<ModelSkeleton>() - 8usize];
    ["Offset of field: ModelSkeleton::boneCount"]
        [::std::mem::offset_of!(ModelSkeleton, boneCount) - 0usize];
    ["Offset of field: ModelSkeleton::bones"]
        [::std::mem::offset_of!(ModelSkeleton, bones) - 8usize];
    ["Offset of field: ModelSkeleton::bindPose"]
        [::std::mem::offset_of!(ModelSkeleton, bindPose) - 16usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct Model {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of Model"][::std::mem::size_of::<Model>() - 136usize];
    ...
    ["Offset of field: Model::skeleton"][::std::mem::offset_of!(Model, skeleton) - 96usize];
    ["Offset of field: Model::currentPose"][::std::mem::offset_of!(Model, currentPose) - 120usize];
    ["Offset of field: Model::boneMatrices"]
        [::std::mem::offset_of!(Model, boneMatrices) - 128usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct ModelAnimation {
    pub name: [::std::os::raw::c_char; 32usize],
    pub boneCount: ::std::os::raw::c_int,
    pub keyframeCount: ::std::os::raw::c_int,
    pub keyframePoses: *mut ModelAnimPose,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ModelAnimation"][::std::mem::size_of::<ModelAnimation>() - 48usize];
    ["Alignment of ModelAnimation"][::std::mem::align_of::<ModelAnimation>() - 8usize];
    ["Offset of field: ModelAnimation::name"]
        [::std::mem::offset_of!(ModelAnimation, name) - 0usize];
    ["Offset of field: ModelAnimation::boneCount"]
        [::std::mem::offset_of!(ModelAnimation, boneCount) - 32usize];
    ["Offset of field: ModelAnimation::keyframeCount"]
        [::std::mem::offset_of!(ModelAnimation, keyframeCount) - 36usize];
    ["Offset of field: ModelAnimation::keyframePoses"]
        [::std::mem::offset_of!(ModelAnimation, keyframePoses) - 40usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct Ray {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of VrDeviceInfo"][::std::mem::size_of::<VrDeviceInfo>() - 60usize];
    ...
    ["Offset of field: VrDeviceInfo::eyeToScreenDistance"]
        [::std::mem::offset_of!(VrDeviceInfo, eyeToScreenDistance) - 16usize];
    ["Offset of field: VrDeviceInfo::lensSeparationDistance"]
        [::std::mem::offset_of!(VrDeviceInfo, lensSeparationDistance) - 20usize];
    ["Offset of field: VrDeviceInfo::interpupillaryDistance"]
        [::std::mem::offset_of!(VrDeviceInfo, interpupillaryDistance) - 24usize];
    ["Offset of field: VrDeviceInfo::lensDistortionValues"]
        [::std::mem::offset_of!(VrDeviceInfo, lensDistortionValues) - 28usize];
    ["Offset of field: VrDeviceInfo::chromaAbCorrection"]
        [::std::mem::offset_of!(VrDeviceInfo, chromaAbCorrection) - 44usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
const _: () = {
    ...
    ["Offset of field: FilePathList::count"][::std::mem::offset_of!(FilePathList, count) - 0usize];
...
pub const ShaderLocationIndex_SHADER_LOC_MATRIX_BONETRANSFORMS: ShaderLocationIndex = 28;
pub const ShaderLocationIndex_SHADER_LOC_VERTEX_INSTANCETRANSFORM: ShaderLocationIndex = 29;
...
pub const ShaderUniformDataType_SHADER_UNIFORM_UINT: ShaderUniformDataType = 8;
pub const ShaderUniformDataType_SHADER_UNIFORM_UIVEC2: ShaderUniformDataType = 9;
pub const ShaderUniformDataType_SHADER_UNIFORM_UIVEC3: ShaderUniformDataType = 10;
pub const ShaderUniformDataType_SHADER_UNIFORM_UIVEC4: ShaderUniformDataType = 11;
pub const ShaderUniformDataType_SHADER_UNIFORM_SAMPLER2D: ShaderUniformDataType = 12;
...
unsafe extern "C" {
    pub fn FileRename(
        fileName: *const ::std::os::raw::c_char,
        fileRename: *const ::std::os::raw::c_char,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    pub fn FileRemove(fileName: *const ::std::os::raw::c_char) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    pub fn FileCopy(
        srcPath: *const ::std::os::raw::c_char,
        dstPath: *const ::std::os::raw::c_char,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    pub fn FileMove(
...
unsafe extern "C" {
    pub fn ChangeDirectory(dirPath: *const ::std::os::raw::c_char) -> bool;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn GetDirectoryFileCount(dirPath: *const ::std::os::raw::c_char) -> ::std::os::raw::c_uint;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn DrawLineDashed(
        startPos: Vector2,
        endPos: Vector2,
        dashSize: ::std::os::raw::c_int,
        spaceSize: ::std::os::raw::c_int,
        color: Color,
    );
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn LoadFontData(
        ...
        glyphCount: *mut ::std::os::raw::c_int,
    ) -> *mut GlyphInfo;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn TextRemoveSpaces(text: *const ::std::os::raw::c_char) -> *const ::std::os::raw::c_char;
}
unsafe extern "C" {
